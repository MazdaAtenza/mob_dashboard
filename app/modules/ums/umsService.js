...
componentApp.factory('umsSelectFieldTypes', function(){
    return {
        fieldTypes: [
            {id: 0, typeName: "全部字段", infoList: []},
            {id: 1, typeName: "基本资料字段", infoList: []},
            {id: 2, typeName: "通用资料字段", infoList: []},
            {id: 3, typeName: "社交资料字段", infoList: []},
            {id: 4, typeName: "自定义资料字段", infoList: []}
        ]
    }
});
...
componentApp.factory("umsUserNumberList", function(){
    return {
        ...
        userList: [
            {ID: "9098674", headImg: "../../../../public/images/avatar5.png", nickname:"阿斯达所多", phoneNo: "12345678901", registerType: "微信", registerTime: "2012-06-18", terminal: "iPhone7", loginTime: "5", operation: "编辑"},
            {ID: "2468012", headImg: "../../../../public/images/avatar5.png", nickname:"二东方新城", phoneNo: "09876543211", registerType: "QQ", registerTime: "2016-06-18", terminal: "iPhone7", loginTime: "6", operation: "编辑"},
            {ID: "1357926", headImg: "../../../../public/images/avatar5.png", nickname:"高合金钢鸡", phoneNo: "18888888888", registerType: "微博", registerTime: "2013-06-18", terminal: "iPhone7", loginTime: "2", operation: "编辑"},
            {ID: "8375189", headImg: "../../../../public/images/avatar5.png", nickname:"国剧盛典所", phoneNo: "16666666666", registerType: "手机号码", registerTime: "2015-06-18", terminal: "iPhone7", loginTime: "8", operation: "编辑"},
         ],
    }
});

componentApp.factory("umsUserSettings", function(){
    return {
        headImg: "../../../../public/images/avatar5.png",
        nickname: "妇科圣手吕大夫",
        mostRegisterTimes: "0",
        readPosition: {
            isOpen: true,
